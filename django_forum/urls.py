...
urlpatterns = [
    # path('', views.home, name='home'), # for FBV
    ...
    # path('boards/<int:pk>/', views.board_topics, name='board_topics'),  # FBV method
    path('boards/<int:pk>/', views.TopicListView.as_view(), name='board_topics'),
    path('boards/<int:pk>/new/', views.new_topic, name='new_topic'),
    # path('boards/<int:pk>/topics/<int:topic_pk>/', views.topic_posts, name='topic_posts'), # FBV method
